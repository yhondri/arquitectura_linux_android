...
static int mi_modulo_release(struct inode *inode, struct file *file)
{
    ...
    if (file->f_mode & FMODE_WRITE) //Abierto por un productor.
    {
        ...
        //     while (counter < consumidores_waiting) //Liberamos a todos los consumidores que están esperando.
        //     {
        //         m_list->consumidores_waiting--;
        //         up(&m_list->consumidores_sem); //Liberar consumidores.
        //         counter++;
        //     }
        // }
    ...
    else if (file->f_mode & FMODE_READ) //Consumidor
    {
        ...
        //     while (counter < productores_waiting) //Liberamos a todos los productores que están esperando.
        //     {
        //         m_list->productores_waiting--;
        //         up(&m_list->productores_sem);
        //         counter++;
