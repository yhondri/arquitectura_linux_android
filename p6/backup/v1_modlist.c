...
int create_new_list(char *list_name)
{
    ...
    list_exist = 0;
    new_list_item = vmalloc(sizeof(struct list_item));
...
void delete_all_lists(void)
{
    ...
    struct list_head *item_head = NULL;
    struct list_head *m_head_auxiliar = NULL;
...
void insert_item(int number)
{
    ...
    struct list_item *new_item = vmalloc(sizeof(struct list_item)); //Reservamos memoria para el nuevo item.
